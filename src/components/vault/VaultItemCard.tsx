...
export const VaultItemCard: React.FC<VaultItemCardProps> = ({ item, onDelete }) => {
  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-4 lg:p-6 hover:shadow-md transition-shadow arca-card-elevated overflow-hidden">
        {/* Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3
              className="font-semibold text-gray-900 dark:text-white text-lg leading-6 pr-2 truncate whitespace-nowrap"
              title={item.title}
            >
              {item.title}
            </h3>
        ...
        {item.type === 'document' && (
          <div className="mb-4">
            <div className="w-full overflow-hidden">
              <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-700/40 border border-gray-200 dark:border-gray-600">
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-green-50 dark:bg-green-900/20 text-green-600">
                    {item.file_type ? getFileIcon(item.file_type) : <FileText className="w-4 h-4" />}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="px-2 py-1 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs">
